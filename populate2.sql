...
INSERT INTO Pessoa (numCC, nome, dataNascimento, genero, nif, morada, telemovel)
VALUES
--atletas socios
(15173794, 'Luis Vaz de Camoes',  '1990-01-15', 'M', 268112111, 'Rua Joaquim Alberto, Porto',      925036570),
(24970519, 'Rui Veloso',          '1992-05-21', 'M', 287360439, 'Avenida Central, Lisboa',         936245817),
(11859362, 'Pedro Abrunhosa',     '1986-12-03', 'M', 245803741, 'Rua das Flores, Braga',           932158496),
(39186724, 'Paulo Gonzo',         '1995-08-02', 'M', 289415462, 'Rua dos Lirios, Porto',           925873363),
(20387450, 'Amalia Rodrigues',    '2003-03-10', 'F', 287524395, 'Travessa dos Amores, Faro',       936497412),
(14692834, 'Diana Chaves',        '2004-07-18', 'F', 285639237, 'Rua das Rosas, Coimbra',          924356879),
(26873945, 'Joao Baiao',          '2003-09-27', 'M', 298437421, 'Avenida da Liberdade, Lisboa',    932599624),
(35768243, 'Joao Manzarra',       '2002-04-09', 'M', 297256312, 'Rua das Oliveiras, Porto',        936215789),
(18273645, 'Cristina Ferreira',   '2002-11-05', 'F', 299537236, 'Travessa das Margaridas, Aveiro', 924534079),
(15173793, 'Miguel Fernandes',    '2004-02-23', 'M', 288900890, 'Rua do Sobreiral, Porto',         963692635),--presi e treinador
--até aqui atletas socios
--apenas atletas
(29574186, 'Julia Pinheiro',      '2000-02-14', 'F', 289631645, 'Rua do Sol, Lisboa',              936531412),
(51837492, 'Diogo Bataguas',      '1993-06-25', 'M', 287626395, 'Rua dos Clerigos, Porto',         925874163),
(64958273, 'Luciana Abreu',       '1996-11-12', 'F', 285649247, 'Rua das Flores, Porto',           924536819),
(78346592, 'Manuel Luis Goucha',  '1989-09-17', 'M', 298637421, 'Rua de Santa Catarina, Porto',    932128624),
(92583746, 'Fatima Lopes',        '1997-07-29', 'F', 297456411, 'Rua do Almada, Porto',            936245711),
(10385729, 'Jose Castelo Branco', '2002-04-06', 'M', 299537297, 'Rua da Boavista, Porto',          924536329),
(11648476, 'Mariana Silva',       '2005-08-13', 'F', 280631245, 'Rua de Cedofeita, Porto',         931287412),
(12593847, 'Bruno Nogueira',      '2011-12-20', 'M', 287634395, 'Rua do Infante, Porto',           925870963),
(13649573, 'Ruth Marlene',        '2013-05-07', 'F', 282649237, 'Rua de Camoes, Porto',            924532819),
(14473958, 'Tony Carreira',       '2014-10-16', 'M', 218657421, 'Rua de Santo Ildefonso, Porto',   932578620),
(15293746, 'Ana Malhoa',          '2001-03-24', 'F', 297356312, 'Rua de Sao Bento, Porto',         936125789),
(16384759, 'Jose Cid',            '1994-09-02', 'M', 299547246, 'Rua do Ouro, Porto',              924535579),
(17495837, 'Mariza',              '1999-07-11', 'F', 282631245, 'Rua das Carmelitas, Porto',       936407412),
(18573946, 'Quim Barreiros',      '2004-02-28', 'M', 287622395, 'Rua de Sao Francisco, Porto',     921874963),
(19648375, 'Claudia Costa',       '2007-06-05', 'F', 281649237, 'Rua das Taipas, Porto',           924533279),
(20395827, 'Andre Santos',        '2010-12-12', 'M', 298677321, 'Rua das Flores, Porto',           932578610),
(21473956, 'Sara Pereira',        '2012-07-29', 'F', 297346312, 'Rua de Santa Catarina, Porto',    936245710),
(22593746, 'Pedro Mendes',        '2015-11-16', 'M', 299587246, 'Rua de Cedofeita, Porto',         924306879),
(23684759, 'Marta Santos',        '2000-09-24', 'F', 289131245, 'Rua de Santo Ildefonso, Porto',   933087412),
(24795837, 'Joao Ferreira',       '1998-08-11', 'M', 287024395, 'Rua de Sao Bento, Porto',         925877263),
(25873946, 'Rita Silva',          '2003-01-28', 'F', 285641237, 'Rua do Ouro, Porto',              924533079),
(26849375, 'Hugo Costa',          '1995-05-15', 'M', 298657321, 'Rua dos Clerigos, Porto',         932578114),
(27593847, 'Ana Santos',          '1998-08-22', 'F', 297451312, 'Rua das Flores, Porto',           936241289),
(28374958, 'Daniel Pereira',      '1999-09-04', 'M', 283649237, 'Rua de Santa Catarina, Porto',    924036879),
(29658473, 'Rafael Silva',        '2001-11-11', 'M', 287644395, 'Rua do Almada, Porto',            965874963),
(30473958, 'Mariana Costa',       '2004-06-30', 'F', 281631245, 'Rua da Boavista, Porto',          936587412),
(31649573, 'William Carvalho',    '2012-05-09', 'M', 298677421, 'Rua de Cedofeita, Porto',         932578624),
(32473956, 'Sofia Costa',         '2014-07-20', 'F', 297416312, 'Rua do Infante, Porto',           936245789),
(33593746, 'Fernando Mendes',     '2016-04-06', 'M', 293547246, 'Rua de Camoes, Porto',            924536879),
--até aqui atletas
--treinadores
...
-- até aqui
--apenas socios 
(18273646, 'Afonso Henriques',        '1997-10-02', 'M', 299537235, 'Rua Orfeao do Porto, Porto',      934534079),
(18273647, 'Barbara Bandeira',        '1978-01-29', 'F', 299537237, 'Rua Colegio do Sardao,',          944534079),
(18273648, 'Pedro Teixeira da Mota',  '1970-11-09', 'M', 299537238, 'Rua da Galeria de Paris, Porto',  954534079),
(18273649, 'Sophia de Mello Breyner', '1984-03-02', 'F', 299537239, 'Rua Julio Dinis, Porto',          964534079),
(18273650, 'Rui Rio',                 '1985-02-16', 'M', 299537240, 'Rua dos Trabalhadores',           974534079),
(18273651, 'Catarina Furtado',        '2004-09-12', 'F', 299537241, 'Rua do Conde de Vizela, Porto',   984534079),
(18273652, 'Patricia Mamona',         '2000-11-05', 'F', 299537242, 'Rua Fernando Pessoa, Porto',      994534079),
(18273653, 'Pepe Ferreira',           '1983-02-26', 'M', 299537243, 'Rua do Dragao, Porto',            904534079),
(18273654, 'Sara Sampaio',            '2004-03-14', 'F', 299537244, 'Rua da Boavista, Porto',          914534079),
(18273655, 'Eder Lopes',              '1990-08-25', 'M', 299537245, 'Rua da Vitoria, Aveiro',          925534079);


INSERT INTO PessoaAtleta (numCC, numFederado, numMedalhas, escalao, idRemo)
VALUES
(15173794, 10512, 5,   'Senior',   101),
(24970519, 15234, 3,   'Senior',   102),
(11859362, 18956, 8,   'Veterano', 103),
(39186724, 25147, 2,   'Senior',   104),
(20387450, 31502, 1,   'Cadete',   105),
(14692834, 42510, 0,   'Junior',   106),
(26873945, 12873, 0,   'Infantil', 107),
(35768243, 21543, 0,   'Iniciado', 108),
(18273645, 30154, 0,   'Minimo',   109),
(15173793, 21790, 100, 'Senior',   110),
--Apenas Atletas
(29574186, 19583, 4,   'Senior',   111),
(51837492, 41023, 2,   'Senior',   112),
(64958273, 31725, 1,   'Senior',   113),
(78346592, 52016, 3,   'Veterano', 114),
(92583746, 63251, 0,   'Senior',   114),
(10385729, 72345, 1,   'Cadete',   115),
(11648476, 81524, 0,   'Junior',   116),
(12593847, 92637, 0,   'Infantil', 117),
(13649573, 10352, 0,   'Iniciado', 118),
(14473958, 11257, 0,   'Minimo',   119),
(15293746, 12245, 3,   'Senior',   120),
(16384759, 13329, 1,   'Senior',   121),
(17495837, 14362, 0,   'Senior',   122),
(18573946, 15547, 0,   'Cadete',   123),
(19648375, 16725, 0,   'Junior',   124),
(20395827, 17684, 0,   'Infantil', 125),
(21473956, 18927, 0,   'Iniciado', 126),
(22593746, 19253, 0,   'Minimo',   127),
(23684759, 20145, 2,   'Senior',   128),
(24795837, 21357, 1,   'Senior',   130),
(25873946, 22563, 0,   'Senior',   131),
(26849375, 23584, 0,   'Senior',   132),
(27593847, 24219, 1,   'Senior',   133),
(28374958, 25576, 2,   'Senior',   134),
(29658473, 26734, 0,   'Cadete',   135),
(30473958, 27451, 0,   'Junior',   136),
(31649573, 28934, 0,   'Infantil', 137),
(32473956, 29875, 0,   'Iniciado', 138),
(33593746, 30256, 0,   'Minimo',   139);


INSERT INTO PessoaSocio (numCC, numSocio, quotasPagas)
VALUES
(15173793, 001, 'TRUE'),
(15173794, 002, 'FALSE'),
(24970519, 003, 'TRUE'),
...
(18273653, 122, 'TRUE'),
(18273654, 123, 'TRUE'),
(18273655, 127, 'TRUE');--ate aqui


INSERT INTO PessoaPresidente (numCC, numMandatos)
VALUES
(15173793, 2);


INSERT INTO PessoaTreinador (numCC)
VALUES
(15173793),
(15173798),
(15174093),
